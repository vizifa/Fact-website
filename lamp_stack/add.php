...
<body>
    ...
    <div class="container display-5 px-4 py-5 my-5 ">
        <h1 class="fw-bold text-center">Contribute a Fact</h1>
        <br>
        <form action="add.php" method="POST">
            <div class="form-group">
                <label class="fw-bold text-start fs-3 py-3">Your Fact</label>
                <input type="text" 
                    class="form-control" 
                    name="fact" />
            </div>
             <div class="form-group">
                <label class="fw-bold text-start fs-3 py-3">Type</label>
    ...
    <?php
        if(isset($_POST["btn"])) {
            ...
            $q="insert into fact.fact_table(data,type)
            values('$fact','$type')";
    ...
    ?>
        ...
        <footer style="margin-top:40px; padding-top:25px; padding-bottom:25px; ;" aria-label="Site Footer" class="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white">
